<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="建团时间" width="150px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="地址" readonly>
          <el-input v-model="temp.address" />
        </el-form-item>

        <el-form-item label="申请内容">
          <el-input v-model="temp.content" readonly
        ...
        <el-form-item label="审核内容">
          <el-input v-model="temp2.content" 
          :autosize="{ minRows: 2, maxRows: 4}" type="textarea" placeholder="Please input" />
        </el-form-item>
...
<el-form :inline="true" :model="temp" class="demo-form-inline">
  ...
  <el-form-item label="姓名">
    <el-input v-model="temp.realname" readonly></el-input>
  </el-form-item>

  <el-form-item label="性别">
    <el-input v-model="temp.sex" readonly></el-input>
  </el-form-item>

  <el-form-item label="社团">
    <el-input v-model="temp.team.name" readonly></el-input>
  </el-form-item>

  <el-form-item label="电话">
    <el-input v-model="temp.tel" readonly></el-input>
  </el-form-item>
  ...
  <el-form-item label="时间">
    <el-input v-model="temp.createTime" readonly></el-input>
  </el-form-item>

  <el-form-item label="家庭地址">
    <el-input v-model="temp.address" readonly></el-input>
  </el-form-item>
  ...
  <el-form-item label="申请内容">
    ...
    <span style="color:red" v-if="activities.length>0">审核记录</span>
    <el-divider></el-divider>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      service({
        url:'applyInfo/queryAppayInfoList',
        method:'get',
    ...
    createData() {
       ...
       * 2、提交数据信息
       * 3、获取后端接口返回状态码
       * 如果成功 重新加载table 让显示最新的数据 同时form窗口隐藏
       */

       service.post('http://localhost:9999/typeInfo/addInfo',this.temp).then(res=>{
        if(res.code==20000){
    ...
    handleQuery(row) {
      ...
      //获取记录集合对象
      this.activities=this.getAppList(row.id);//获取审核记录的id
      // this.$nextTick(() => {
      //   this.$refs['dataForm'].clearValidate()
      // })
    },
    ...
    updateData() {
      this.temp2.appId=this.temp.id;//把当前对象的id赋值给appId
      console.log(this.temp)
      debugger
      service.post('applyInfo/addAppInfo',this.temp2).then(res=>{
        if(res.code==20000){
          this.dialogFormVisible = false
          this.$notify({
              title: 'Success',
    ...
    handleDelete(row, index) {
      service('applyInfo/deleteById?id='+row.id).then(res=>{
        if(res.code == 20000){
          this.$notify({
            title: 'Success',
